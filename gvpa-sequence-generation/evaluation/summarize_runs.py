...
SUMMARY_FIELDS = [
    ...
    "median_nearest_train_identity",
    "p05_nearest_train_identity",
    "p95_nearest_train_identity",
    "max_nearest_train_identity",
    "novel_sequence_rate",
    "novel_below_70_identity_rate",
    "novel_below_80_identity_rate",
    "novel_below_90_identity_rate",
    "unique_ratio",
